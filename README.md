...
7. Si no deja activar Nested VT-x/AMD-v, usar la comanda: BoxManage modifyvm "nombre_de_vm" –nested-hw-virt on
...
43. El error desaparece y ya está listo para usar
